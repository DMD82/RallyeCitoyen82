// ============================================================
// NAV.JS — Navigation PC Organisation
// Rallye Citoyen 2026 — dmd82.fr/PC
// ============================================================
...
function injectNav() {
  ...
  style.textContent = `
    .gn-wrap { background:#1a2744; position:sticky; top:0; z-index:200; box-shadow:0 2px 16px rgba(0,0,0,0.3); }
    .gn-top { display:flex; align-items:center; gap:8px; padding:8px 16px; max-width:1200px; margin:0 auto; border-bottom:1px solid rgba(255,255,255,0.07); }
    ...
    .gn-brand-title { font-family:'Libre Baskerville',serif; font-weight:700; font-size:13px; color:#fff; white-space:nowrap; overflow:hidden; text-overflow:ellipsis; }
    ...
    .gn-a { display:flex; align-items:center; gap:5px; padding:8px 10px; font-family:'IBM Plex Mono',monospace; font-size:10px; font-weight:600; letter-spacing:.03em; text-transform:uppercase; color:rgba(255,255,255,0.4); text-decoration:none; border-bottom:2px solid transparent; white-space:nowrap; flex-shrink:0; transition:color .15s,border-color .15s; }
    .gn-a:hover { color:rgba(255,255,255,0.75); }
    .gn-a.active { color:#fff; border-bottom-color:#b8932a; }
    ...
    @media (max-width:860px) { .gn-ham { display:flex; } .gn-bar { display:none; } .gn-mob { display:flex; } .gn-date { display:none; } }
  `;
